...
const dados = [
    {
        ...
        O profissional designer gráfico tem como objetivo estabelecer a comunicação, garantindo que a mensagem seja entregue da melhor forma possível, seja elaborando uma embalagem para um produto, criando um cartão de visita ou o visual de uma empresa. Sua principal missão é resolver o problema proposto de forma criativa fazendo uso de diversos conhecimentos técnicos pertinentes.
        `
    },
    {
        ...
        return html`
            <div class="initial-concept">
                ...
                <div class="initial-concept__rightSide">
                    ...
                    ${dados.map(dado => html`<course-collapsed-button label=${dado.label} text=${dado.text}></course-collapsed-button>`)}
